...
class Mainpage extends Component {
  state = {
    provide: [
      ...
      "Free member card with a minimum purchase of VND 200.000.",
    ],
    reviews: [
      {
        name: "Foo Barr",
            ...
            <div className="flex flex-row flex-wrap justify-center gap-12 mt-20">
              {Array("", "", "").map((item, idx) => (
                ...
                >
                  ...
                  />
                  <h3 className="text-lg font-medium">Coconut Latte</h3>
                  <ul className="flex flex-col gap-5 mb-8 md:mb-20">
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Coconut Syrup
                    </li>
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Vanilla Cream
                    </li>
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Ice / Hot
                    </li>
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Coconut Flakes on Top
                    </li>
                  </ul>
                  <p className="font-medium text-2xl">25.000 VND</p>
