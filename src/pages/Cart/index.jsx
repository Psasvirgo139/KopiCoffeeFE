...
<aside className="flex-1 flex flex-col gap-6">
  {/* Address Details */}
  <div>
    {/* ĐÃ DI CHUYỂN TIÊU ĐỀ VÀO TRONG KHUNG TRẮNG BÊN DƯỚI
      VÀ XÓA BỎ 'space-y-4' KHỎI KHUNG ĐỂ THÊM VÀO WRAPPER
    */}
    <section className="bg-white rounded-2xl shadow-lg p-6 lg:p-7">
      {/* Đây là tiêu đề đã được di chuyển vào và chỉnh sửa (màu chữ, bỏ shadow) */}
      <section className="text-tertiary text-xl lg:text-2xl font-extrabold mb-4 relative flex items-center justify-between">
        <span>Address details</span>
        <div className="flex gap-3">
          {editMode && (
            <button
              onClick={() => setShowMapModal(true)}
              className="text-sm bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-lg transition-colors font-medium text-gray-700"
            >
              Use Map
            </button>
          )}
      ...
      {/* Thêm một wrapper div để giữ lại 'space-y-4' cho nội dung bên dưới */}
  ...
  <div>
    {/* ĐÃ DI CHUYỂN TIÊU ĐỀ VÀO TRONG KHUNG TRẮNG BÊN DƯỚI
      VÀ XÓA BỎ 'space-y-3' KHỎI KHUNG ĐỂ THÊM VÀO WRAPPER
    */}
    <section className="bg-white rounded-2xl shadow-lg p-6 lg:p-7">
      {/* Đây là tiêu đề đã được di chuyển vào và chỉnh sửa (màu chữ, bỏ shadow) */}
      <section className="text-tertiary text-xl lg:text-2xl font-extrabold mb-4">
        Payment method
      </section>
      
      {/* Thêm một wrapper div để giữ lại 'space-y-3' cho nội dung bên dưới */}
